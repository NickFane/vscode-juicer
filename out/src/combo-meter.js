...
class ComboMeter {
    constructor() {
        ...
        this.getSharedStyles = (comboCount, frameCount = 0) => {
            // Because the size and color do not start to change until VSCode Juicer starts, we cannot use the raw "count" to calculate those values
            // or else there will be a large jump when VSCode Juicer activates, so instead use the value relative to the combo at which VSCode Juicer started.
